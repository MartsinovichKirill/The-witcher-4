...
namespace WitcherRightVersion.Editor
{
    public static class MvpAcceptanceValidator
    {
        ...
        private static void ValidateVelemarWorldAcceptance(List<string> failures)
        {
            ...
            RequireObject("OrtenMirrorStaffProp", failures);
            ...
            RequireObject("WorldAlchemyTable_Swallow_AlchemyTableProp", failures);
            ...
            RequireObject("WorldForge_ReinforcedArmor_ForgeBladeProp", failures);
            RequireObject<DecisionFlagInteractable>("WorldGirlMedallion", failures);
            RequireObject("WorldGirlMedallion_MedallionProp", failures);
            RequireObject<DecisionFlagInteractable>("WorldOrtenDiary", failures);
            RequireObject("WorldOrtenDiary_DiaryTableProp", failures);
            RequireObject<DecisionFlagInteractable>("WorldMirrorShardCache", failures);
            RequireObject("WorldMirrorShardCache_ShardA", failures);
            ...
            RequireObject("WorldElderSealProof_BannerProp", failures);
            ...
            RequireObject("FinalElsaStaffProp", failures);
            ...
            RequireObject("FinalIvarBowProp", failures);
