...
namespace WitcherRightVersion.Localization
{
    public static class GameLocalization
    {
        ...
        {
            { "Reynard", "Рейнард" },
            { "World drowner", "Утопец" },
            { "First drowner", "Первый утопец" },
            { "Nest drowner", "Утопец из гнезда" },
            { "Forest wolf", "Лесной волк" },
            { "Tower skeleton guard", "Скелет-страж башни" },
            { "Ash Road bandit", "Бандит с Пепельного тракта" },
            { "Skeleton guard", "Скелет-страж" },
            { "Drowner", "Утопец" },
            { "Drowner is dead.", "Утопец мёртв." },
            { "Skeleton guard is dead.", "Скелет-страж повержен." },
            { "Enemy is dead.", "Противник мёртв." },
            { "Quest updated.", "Квест обновлён." },
            { "Nothing useful yet.", "Пока ничего полезного." },
            { "Interaction complete.", "Действие выполнено." },
            { "Evidence recorded.", "Улика записана." },
            { "Supplies taken.", "Припасы взяты." },
            { "Supplies bought.", "Припасы куплены." },
            { "Not enough coins.", "Недостаточно монет." },
            { "No more supplies for now.", "Припасов пока больше нет." },
            { "Loot collected.", "Добыча собрана." },
            { "Light attack missed.", "Лёгкая атака не достигла цели." },
            { "Heavy attack missed.", "Тяжёлая атака не достигла цели." },
            { "Nest drowner is dead. Keep clearing the den.", "Утопец из гнезда мёртв. Продолжай зачищать логово." },
            { "The forest wolf is dead.", "Лесной волк мёртв." },
            { "The ambusher falls.", "Налётчик повержен." },
            { "Voytsekh's enforcer falls back from the ash road.", "Головорез Войцеха отступает с пепельного тракта." },
            { "Stay near the altar.", "Держись возле алтаря." },
            { "Watch the road.", "Следи за дорогой." },
            { "You chose a witness over comfort, witcher. The old road remembers that. I can steady the rite, but I cannot choose for you.", "Ты выбрал свидетеля, а не покой, ведьмак. Старая дорога это помнит. Я могу удержать обряд, но выбрать за тебя не смогу." },
            { "You pulled me out when the forest wanted payment. I owe you one clean shot if Voytsekh's men try to make this ugly.", "Ты вытащил меня, когда лес требовал плату. За мной один точный выстрел, если люди Войцеха решат всё испортить." },
            { "Voytsekh's enforcer", "Головорез Войцеха" },
